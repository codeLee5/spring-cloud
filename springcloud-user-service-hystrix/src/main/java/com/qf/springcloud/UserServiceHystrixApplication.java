...
@MapperScan(basePackages = {"com.qf.springcloud.dao"})
@EnableCircuitBreaker//开启熔断
public class UserServiceHystrixApplication {
    Logger logger = LoggerFactory.getLogger(UserServiceHystrixApplication.class);
    ...
    void setTimezone() {
        ...
        TimeZone.setDefault(TimeZone.getTimeZone("Asia/Shanghai"));// 设置服务器的时区跟数据库的时区一致
    }
